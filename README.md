...
[![Tests](https://github.com/openedx-actions/tutor-plugin-build-credentials/actions/workflows/testRelease.yml/badge.svg)](https://github.com/openedx-actions/tutor-plugin-build-credentials/actions)
  ...
  build:
    ...
    steps:
      ...
      - name: Build the image and upload to AWS ECR
        uses: openedx-actions/tutor-plugin-build-credentials@v1.0.1
        with:
          version: "latest"
